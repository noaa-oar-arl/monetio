...
def add_data(self, dates, box=None, country=None, state=None, site=None, resample=True, window='H'):
    ...
    """
    ish = ISH()
    df = ish.add_data(dates, box=None, country=None, state=None, site=None, resample=True, window='H')
    return df
...
class ISH(object):
    ...
    def _clean(self, frame):
        ...
        # index by time
        frame['time'] = [pd.Timestamp('{:08}{:04}'.format(date, htime)) for date, htime in zip(frame['date'], frame['htime'])]
    ...
    def add_data(self, dates, box=None, country=None, state=None, site=None, resample=True, window='H'):
        ...
        try:
            ...
            pass
        self.df = self.df.merge(dfloc[['station_id', 'latitude', 'longitude', 'station name']], on=['station_id'], how='left')
